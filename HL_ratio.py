...
vertical_fractures = Entities.Fractures(shp='data/Pontrelli/verticale/Set_2.shp', set_n=1)
vertical_boundary = Entities.Boundary(shp='data/Pontrelli/verticale/Interpretation_boundary.shp', group_n=1)
